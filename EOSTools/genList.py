...
if __name__ == "__main__":
  ...
  parser.add_option ('-e',      dest='eosurl',     type='string',    default = "root://eoscms.cern.ch",      help="Eos url (Defaults to root://eoscms.cern.ch)")
  parser.add_option ('-m',      dest='match',      type='string',    default = ".*analysis.*\.root$",        help="File paths must match this regular expression")
