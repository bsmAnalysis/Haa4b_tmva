...
class TMVATrainer
{
 ...
 private:
  ...
  {
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass12.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass15.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass20.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass25.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass30.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass40.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass50.root"), 1.0),
  std::make_pair( dir + std::string("mva_MC13TeV_Wh_amass60.root"), 1.0),
  ...
  std::make_pair( dir + std::string("HaddExt/mva_LHE0Jets_mva_MC13TeV_WJets_all_2016.root"), 25.7282),
  std::make_pair( dir + std::string("HaddExt/mva_LHE1Jets_mva_MC13TeV_WJets_all_2016.root"), 6.85513),
  std::make_pair( dir + std::string("HaddExt/mva_LHE2Jets_mva_MC13TeV_WJets_all_2016.root"), 2.11101),
  ...
  std::make_pair( dir + std::string("HaddExt/mva_LHE4Jets_mva_MC13TeV_DYJetsToLL_10to50_all_2016.root"   ), 0.763872),
  std::make_pair( dir + std::string("HaddExt/mva_LHE0Jets_mva_MC13TeV_DYJetsToLL_50toInf_all_2016.root"  ), 1.41826),
  std::make_pair( dir + std::string("HaddExt/mva_LHE1Jets_mva_MC13TeV_DYJetsToLL_50toInf_all_2016.root"  ), 0.468798),
  std::make_pair( dir + std::string("HaddExt/mva_LHE2Jets_mva_MC13TeV_DYJetsToLL_50toInf_all_2016.root"  ), 0.471764),
  std::make_pair( dir + std::string("HaddExt/mva_LHE3Jets_mva_MC13TeV_DYJetsToLL_50toInf_all_2016.root"  ), 0.469104),
  std::make_pair( dir + std::string("HaddExt/mva_LHE4Jets_mva_MC13TeV_DYJetsToLL_50toInf_all_2016.root"  ), 0.381347),
  //TG, TTG, TTW, TTZ
  //std::make_pair( dir + std::string("mva_MC13TeV_TGJets_2016.root"                  ), 0.288736*0.25),
  //std::make_pair( dir + std::string("mva_MC13TeV_TGJets_ext1_2016.root"             ), 0.288736*0.75), //ext1
  ...
  //std::make_pair( dir + std::string("mva_MC13TeV_WWlnu2q_ext1_2016.root"            ), 0.199298*0.5), //ext1
  ...
  //Tri-boson
  std::make_pair( dir + std::string("mva_MC13TeV_ZZZ_2016.root"                     ), 0.0355368),
  std::make_pair( dir + std::string("mva_MC13TeV_WZZ_2016.root"                     ), 0.0267381),
  std::make_pair( dir + std::string("mva_MC13TeV_WWZ_2016.root"                     ), 0.00922509),
  std::make_pair( dir + std::string("mva_MC13TeV_WWW_4F_2016.root"                  ), 0.00235191),
  //QCD
  //std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt20To30_EMEnr_2016.root"      ), 1.0), //0 events, co3b, co4b
  //std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt30To50_EMEnr_2016.root"      ), 1.0), //0 events, co3b, co4b
  //std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt30To50_EMEnr_ext1_2016.root" ), 1.0), //0 events, co3b, co4b
  //std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt50To80_EMEnr_2016.root"      ), 4416.95),
  std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt80To120_EMEnr_2016.root"     ), 350.246),
  std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt120To170_EMEnr_2016.root"    ), 63.0513),
  std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt170To300_EMEnr_2016.root"    ), 58.4617),
  std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt300ToInf_EMEnr_2016.root"    ), 6.56669),
  std::make_pair( dir + std::string("mva_MC13TeV_QCD_Pt20ToInf_MuEnr_2016.root"     ), 491.35)
  };
};
#endif
