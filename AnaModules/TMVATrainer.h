...
class TMVATrainer
{
 ...
 private:
  ...
  std::make_pair( dir + std::string("HaddExt/mva_MC13TeV_DYJetsToLL_10to50_all_2016.root"   ), 12.8647),
  std::make_pair( dir + std::string("HaddExt/mva_MC13TeV_DYJetsToLL_50toInf_all_2016.root"  ), 1.09232),
  //TG, TTG, TTW, TTZ
